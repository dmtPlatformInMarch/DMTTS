...
class TextAudioSpeakerLoader(torch.utils.data.Dataset):
    ...
    def __init__(self, audiopaths_sid_text, hparams):
        ...
        self.lang_list = hparams.lang_list #################################
    ...
    def get_audio_text_speaker_pair(self, audiopath_sid_text):
        ...
        audiopath, sid, language, text, phones, tone = audiopath_sid_text

        # def get_text(self, text, phone, tone, language_str, wav_path,lang_list):
        phones, tone, language = self.get_text(
            text, phones, tone, language, audiopath, 
        )
    ...
    def get_text(self, text, phone, tone, language_str, wav_path):
        #print(f"before clean_text_to_sequence:  {tone}")
        phone, tone, language = cleaned_text_to_sequence(phone, tone, language_str, lang_list=self.lang_list) #########
        #print(f"tone:    {tone}")
        #exit()
        if self.add_blank:
